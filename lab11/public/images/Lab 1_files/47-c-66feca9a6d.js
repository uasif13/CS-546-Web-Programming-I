...
let t=l.offset(),s=l.outerWidth(),n=l.outerHeight(),b=t.top,h=b+n,a=t.left,p=a+s,o="html,body"==this.selector?u.a.windowScrollTop():this.scrollTop(),c=this.scrollLeft(),r=this.outerHeight(),_=this.outerWidth()
...
a-=c
h-=o
p-=c}b<0||r<n&&h>r?e.scrollTop=b+o:h>r&&(e.scrollTop=h+o-r+20)
a<0?e.scrollLeft=a+c:p>_&&(e.scrollLeft=p+c-_+20)
...
//# sourceMappingURL=47-c-66feca9a6d.js.map