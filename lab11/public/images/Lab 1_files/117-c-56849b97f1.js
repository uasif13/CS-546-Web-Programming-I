(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[117],{"7LJr":function(e,i,t){"use strict"
var r=t("ouhR")
var n=t.n(r)
...
var g=t("ouhR")
var b=t.n(g)
var f=Object(n["a"])(d["a"].Separator,{})
class m extends o.a.Component{render(){const e=this.props,i=e.rubric,t=e.duplicateFunction
...
var w=l["default"].scoped("RubricManagement")
var y=t("6vK/")
var C=t("agq5")
var P=t("Xx/m")
var x=t("we39")
...
return Object(n["a"])(z["a"].Row,{},void 0,Object(n["a"])(z["a"].Cell,{textAlign:"center"},void 0,Object(n["a"])("div",{style:{display:"inline-block"}},void 0,o.a.createElement(B["a"],{ref:e=>{this.radioInput=e},label:Object(n["a"])(L["a"],{},void 0,E["a"].t("Change mastery")),checked:s,onChange:this.handleMasteryChange}))),Object(n["a"])(z["a"].Cell,{},void 0,o.a.createElement(A["a"],{ref:this.setDescriptionRef,renderLabel:Object(n["a"])(L["a"],{},void 0,E["a"].t("Change description")),messages:this.errorMessage(r),onChange:this.handleDescriptionChange,defaultValue:t})),Object(n["a"])(z["a"].Cell,{},void 0,o.a.createElement(A["a"],{ref:this.setPointsRef,renderLabel:Object(n["a"])(L["a"],{},void 0,E["a"].t("Change points")),messages:this.errorMessage(d),onChange:this.handlePointChange,defaultValue:E["a"].n(c),width:"4rem"})),Object(n["a"])(z["a"].Cell,{},void 0,Object(n["a"])("span",{style:{whiteSpace:"nowrap"}},void 0,Object(n["a"])(N["a"],{on:"click",show:this.state.showColorPopover,onToggle:this.handleMenuToggle},void 0,Object(n["a"])(N["a"].Trigger,{},void 0,o.a.createElement(P["a"],{ref:this.setColorRef,variant:"link"},Object(n["a"])("div",{},void 0,Object(n["a"])("span",{className:"colorPickerIcon",style:{background:T(i)}}),E["a"].t("Change")))),Object(n["a"])(N["a"].Content,{},void 0,Object(n["a"])(S["b"],{parentComponent:"ProficiencyRating",colors:S["a"],currentColor:T(i),isOpen:true,hidePrompt:true,nonModal:true,hideOnScroll:false,withAnimation:false,withBorder:false,withBoxShadow:false,withArrow:false,focusOnMount:false,afterClose:this.handleMenuClose,setStatusColor:this.setColor}))),Object(n["a"])("div",{className:"delete"},void 0,Object(n["a"])(P["a"],{disabled:a,buttonRef:this.setTrashRef,onClick:this.handleDelete,variant:"icon",icon:M},void 0,Object(n["a"])(L["a"],{},void 0,E["a"].t("Delete proficiency rating")))))))}}I.defaultProps={descriptionError:null,focusField:null,pointsError:null}
I.displayName="Row"
var F=t("xDdU")
var K=t.n(F)
var U=t("GLiE")
...
var G=t("JPcv")
var H=t("x1Tw")
const q=e=>H["a"].get("/api/v1/accounts/".concat(e,"/outcome_proficiency"))
const W=(e,i)=>H["a"].post("/api/v1/accounts/".concat(e,"/outcome_proficiency"),i)
var J=t("HbFp")
var Y=t("f6Li")
const Z="EF4437"
function $(e){if("#"===e[0])return e.substring(1)
return e}var X=Object(n["a"])(j["a"],{},void 0,Object(n["a"])(Y["a"],{url:"/images/trophy.svg"}))
var Q=Object(n["a"])(x["a"],{})
...
else{b.a.flashError(R["a"].t("An error occurred while loading account proficiency ratings"))
this.setState({loading:false})}}).catch(e=>{e.response&&404!==e.response.status&&b.a.flashError(R["a"].t("An error occurred while loading account proficiency ratings: %{m}",{m:e.response.statusText}))
...
return{rows:i}})
b.a.screenReaderFlashMessage(R["a"].t("Added new proficiency rating"))}
...
b.a.screenReaderFlashMessage(R["a"].t("Proficiency Rating deleted"))})
...
this.handleSubmit=()=>{this.checkForErrors()||W(this.props.accountId,this.stateToConfig()).then(e=>{200===e.status?b.a.flashMessage(R["a"].t("Account proficiency ratings saved")):b.a.flashError(R["a"].t("An error occurred while saving account proficiency ratings"))})}
this.checkForErrors=()=>{let e=null
let i=true
const t=this.state.rows.map(t=>{let r=t
if(this.invalidDescription(t.get("description"))){r=r.set("descriptionError",R["a"].t("Missing required description"))
if(i){r=r.set("focusField","description")
i=false}}if(this.invalidPoints(t.get("points"))){e=null
r=r.set("pointsError",R["a"].t("Invalid points"))
if(i){r=r.set("focusField","points")
i=false}}else if(t.get("points")<0){r=r.set("pointsError",R["a"].t("Negative points"))
if(i){r=r.set("focusField","points")
i=false}}else{const n=t.get("points")
if(null!==e&&e<=n){r=r.set("pointsError",R["a"].t("Points must be less than previous rating"))
if(i){r=r.set("focusField","points")
...
return{rows:i}})}renderSpinner(){return Object(n["a"])("div",{style:{textAlign:"center"}},void 0,Object(n["a"])(D["a"],{renderTitle:R["a"].t("Loading"),size:"large",margin:"0 0 0 medium"}))}renderBillboard(){const e={width:"10rem",margin:"0 auto"}
const i={textAlign:"center"}
return Object(n["a"])("div",{style:i},void 0,o.a.createElement(C["a"],{headingAs:"h2",headingLevel:"h2",ref:e=>{this.triggerRoot=e},hero:Object(n["a"])("div",{style:e},void 0,X),heading:R["a"].t("Customize Learning Mastery Ratings"),message:R["a"].t("\n            Set up how your Proficiency Ratings appear inside of Learning Mastery Gradebook.\n            Adjust number of ratings, mastery level, points, and colors.\n          ").trim()}),Object(n["a"])(P["a"],{variant:"primary",onClick:this.removeBillboard},void 0,R["a"].t("Get Started")))}renderTable(){const e=this.state.masteryIndex
return Object(n["a"])("div",{},void 0,Object(n["a"])(z["a"],{caption:R["a"].t("Proficiency ratings")},void 0,Object(n["a"])(z["a"].Head,{},void 0,Object(n["a"])(z["a"].Row,{},void 0,Object(n["a"])(z["a"].ColHeader,{id:"mastery-column",width:"1%"},void 0,R["a"].t("Mastery")),Object(n["a"])(z["a"].ColHeader,{id:"rating-column"},void 0,R["a"].t("Proficiency Rating")),Object(n["a"])(z["a"].ColHeader,{id:"points-column",width:"1%"},void 0,R["a"].t("Points")),Object(n["a"])(z["a"].ColHeader,{id:"color-column",width:"1%"},void 0,R["a"].t("Color")))),Object(n["a"])(z["a"].Body,{},void 0,this.state.rows.map((i,t)=>Object(n["a"])(I,{color:i.get("color"),description:i.get("description"),descriptionError:i.get("descriptionError"),disableDelete:1===this.state.rows.size,focusField:i.get("focusField")||(0===t?"mastery":null),points:i.get("points").toString(),pointsError:i.get("pointsError"),mastery:t===e,onColorChange:this.handleColorChange(t),onDelete:this.handleDelete(t),onDescriptionChange:this.handleDescriptionChange(t),onMasteryChange:this.handleMasteryChange(t),onPointsChange:this.handlePointsChange(t)},i.get("key"))),Object(n["a"])(z["a"].Row,{},void 0,Object(n["a"])(z["a"].Cell,{colSpan:"4",textAlign:"center"},void 0,Object(n["a"])(P["a"],{onClick:this.addRow,icon:Q,variant:"circle-primary"},void 0,Object(n["a"])(L["a"],{},void 0,R["a"].t("Add proficiency rating"))))))),Object(n["a"])("div",{className:"save"},void 0,Object(n["a"])(P["a"],{variant:"primary",onClick:this.handleSubmit},void 0,R["a"].t("Save Learning Mastery"))))}render(){const e=this.state,i=e.billboard,t=e.loading
...
return e},updateMasteryScale(e){var i
if(!(null===(i=ENV.MASTERY_SCALE)||void 0===i?void 0:i.outcome_proficiency))return
const t=ENV.MASTERY_SCALE.outcome_proficiency.ratings
const r=t.find(e=>e.mastery).points
const n=t[0].points
e.find(".criterion:not(.blank)").each((function(){const e=b()(this)
if(!e.hasClass("learning_outcome_criterion"))return
e.find(".criterion_points").val(n).blur()
e.find(".mastery_points").text(r)
const i=e.find(".rating:not(.blank)")
if(i.length<t.length)for(let r=i.length;r<t.length;r++)e.find(".rating:not(.blank):first").addClass("add_column").click()
e.find(".rating:not(.blank)").each((function(e){const i=ENV.MASTERY_SCALE.outcome_proficiency.ratings[e]
i?b()(this).fillTemplateData({data:i}):b()(this).remove()}))}))},editRubric(e,i){let t=arguments.length>2&&void 0!==arguments[2]&&arguments[2]
let r,n,a,o
b()("#add_criterion_container").remove()
ge.isEditing=true
r=e.clone(true).addClass("editing")
r.find(".edit_rubric").remove()
n=r.getTemplateData({textValues:["use_for_grading","free_form_criterion_comments","hide_score_total","hide_points","hide_outcome_results"]})
e.hide().after(r.show())
t&&ge.updateMasteryScale(r)
a=b()("#edit_rubric").clone(true).show().removeAttr("id").addClass("edit_rubric")
o=a.find("#edit_rubric_form")
r.find(".rubric_table").append(a)
...
const s=ae.t("buttons.create_rubric","Create Rubric")
const c=ae.t("buttons.update_rubric","Update Rubric")
o.find(".save_button").text("rubric_new"==r.attr("id")?s:c)
o.attr("method","PUT").attr("action",i)
ge.sizeRatings()
ge.updateAddCriterionLinks(r)
return r},hideEditRubric(e,i){ge.isEditing=false
e=e.filter(":first")
e.hasClass("editing")||(e=e.next(".editing"))
...
const i=b()(this),t=i.parents(".rubric"),r=me(t)
if(ge.isEditing)return false
i.hasClass("copy_edit")&&!confirm(fe(r))||ge.editRubric(t,i.attr("href"),r)}))
...
b.a.ajaxJSON(n,"POST",t,e=>{var t
i.loadingImage("remove")
let r=b()("#rubrics .rubric:visible:first")
0===r.length&&(r=ge.addRubric())
const n=e.rubric
...
n.permissions.delete_association=e.rubric_association.permissions.delete}ge.updateRubric(r,n)
ge.updateRubricPoints(r)
ge.hideEditRubric(r,false)
i.dialog("close");(null===(t=n.permissions)||void 0===t?void 0:t.update)||r.find(".edit_rubric_link").addClass("copy_edit")},()=>{i.loadingImage("remove")})}))
...
c.a.render(Object(n["a"])(ne,{accountId:e}),document.getElementById("rubric_management"))}const fe=e=>{if(!e)return ae.t("You can't edit this rubric, either because you don't have permission or it's being used in more than one place. Any changes you make will result in a new rubric based on the old rubric. Continue anyway?")
return ENV.context_asset_string.includes("course")?ae.t("You can't edit this rubric, either because you don't have permission or it's being used in more than one place. Any changes you make will result in a new rubric. Any associated outcome criteria will use the course mastery scale. Continue anyway?"):ae.t("You can't edit this rubric, either because you don't have permission or it's being used in more than one place. Any changes you make will result in a new rubric. Any associated outcome criteria will use the account mastery scale. Continue anyway?")}
const me=e=>{if(!ENV.ACCOUNT_LEVEL_MASTERY_SCALES)return false
return e.find(".criterion").hasClass("learning_outcome_criterion")}
var he=ge
...
var ve=l["default"].scoped("EditRubricPage")
var ke=t("B0dq")
var we=t("dSIe")
class ye{static initClass(){this.prototype.$els={}
this.prototype.translations={findOutcome:ve.t("titles.find_outcomes","Find Outcomes")}}constructor(){this.onFindOutcome=e=>{e.preventDefault()
this.dialogCreated||this.createDialog()
this.$els.dialog.show()
return this.$els.dialog.$el.find(".alert").focus()}
this.rootOutcomeGroup=new ke["a"](ENV.ROOT_OUTCOME_GROUP)
this.attachInitialEvent()
this.dialogCreated=false}attachInitialEvent(){this.$els.rubricWrapper=b()("#rubrics")
return this.$els.rubricWrapper.on("click","a.find_outcome_link",this.onFindOutcome)}createDialog(){this.$els.dialog=new we["a"]({title:this.translations.findOutcome,selectedGroup:this.rootOutcomeGroup,useForScoring:true,shouldImport:false,disableGroupImport:true,rootOutcomeGroup:this.rootOutcomeGroup})
this.$els.dialog.on("import",this.onOutcomeImport)
return this.dialogCreated=true}onOutcomeImport(e){return he.onFindOutcome(e)}}ye.initClass()
document.addEventListener("rubricEditDataReady",e=>{new ye
he.init()})},ZbFs:function(e,i,t){"use strict"
...
var L=(C=Object(h["j"])(y,j),C(P=(R=x=function(e){Object(d["a"])(i,e)
function i(){var e
var t
Object(a["a"])(this,i)
...
return l.a.createElement("span",{className:j.heading},l.a.createElement(f["a"],{level:i,as:t,color:"primary"},r))}},{key:"renderHero",value:function(){return this.heroIsFunction?this.props.hero(this.SVGIconSize):this.props.hero}},{key:"renderContent",value:function(){var e=this.props,i=e.heading,t=e.message,r=e.hero
return l.a.createElement("span",{className:j.content},r&&l.a.createElement("span",{className:j.hero},this.renderHero()),i&&this.renderHeading(),t&&l.a.createElement("span",{className:j.message},Object(v["a"])(t)))}},{key:"render",value:function(){var e
var t=this.props,a=t.href,o=t.disabled,s=t.readOnly,c=t.onClick,d=t.size,_=t.margin,u=t.elementRef
var p=(e={},Object(n["a"])(e,j.root,true),Object(n["a"])(e,j[d],true),Object(n["a"])(e,j.clickable,a||c),Object(n["a"])(e,j.disabled,o),e)
var g=Object(k["a"])(i,this.props)
return l.a.createElement(m["a"],{as:"div",margin:_},l.a.createElement(m["a"],Object.assign({},Object(w["a"])(this.props,Object(r["a"])({},i.propTypes,{},m["a"].propTypes)),{type:"button"===g?"button":null,as:g,elementRef:u,className:b()(p),href:a,onClick:this.handleClick,disabled:o,"aria-disabled":o||s?"true":null}),this.renderContent()))}},{key:"heroIsFunction",get:function(){return"function"===typeof this.props.hero}},{key:"SVGIconSize",get:function(){var e=this.props.size
return"small"===e?"medium":"large"===e?"x-large":"large"}}])
i.displayName="Billboard"
return i}(_["Component"]),x.propTypes={hero:p.a.oneOfType([p.a.element,p.a.func]),size:p.a.oneOf(["small","medium","large"]),as:p.a.elementType,elementRef:p.a.func,heading:p.a.string,headingAs:p.a.oneOf(["h1","h2","h3","span"]),headingLevel:p.a.oneOf(["h1","h2","h3","h4"]),message:p.a.oneOfType([p.a.node,p.a.func]),onClick:p.a.func,href:p.a.string,disabled:p.a.bool,readOnly:p.a.bool,margin:h["c"].spacing},x.defaultProps={margin:void 0,disabled:false,readOnly:false,href:void 0,message:void 0,onClick:void 0,heading:void 0,hero:void 0,size:"medium",headingAs:"span",headingLevel:"h1",as:"span",elementRef:function(e){}},R))||P)},"rf+m":function(e,i,t){"use strict"
t.d(i,"a",(function(){return u}))
var r=t("VTBJ")
var n=t("1OyB")
var a=t("vuIU")
...
//# sourceMappingURL=117-c-56849b97f1.js.map